...
import { CreateEncounterDto, AddendumDto } from './dto/encounter.dto';
export declare class ClinicalController {
    private clinicalService;
    constructor(clinicalService: ClinicalService);
    createEncounter(userId: string, dto: CreateEncounterDto): Promise<({
        diagnoses: ({
            cie10Entry: {
                id: string;
                code: string;
    ...
    updateEncounter(userId: string, id: string, dto: Partial<CreateEncounterDto>): Promise<({
        diagnoses: ({
            cie10Entry: {
                id: string;
                code: string;
    ...
    closeEncounter(userId: string, id: string): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        status: import(".prisma/client").$Enums.EncounterStatus;
    ...
    getEncounter(id: string): Promise<({
        diagnoses: ({
            cie10Entry: {
                id: string;
                code: string;
    ...
    addAddendum(userId: string, id: string, dto: AddendumDto): Promise<{
        id: string;
        createdAt: Date;
        motivoAclaracion: string;
        contenido: string;
    ...
    getPatientSummary(userId: string, patientProfileId: string): Promise<{
        profile: ({
            identification: {
                id: string;
                createdAt: Date;
